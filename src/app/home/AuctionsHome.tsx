...
import { FeaturedItemsCarousel } from "../auctions/featured-items/FeaturedItemsCarousel";
import { AuctionBrowseItems } from "../auctions/auction/AuctionBrowseItems";
import { AuctionAlertCarousel } from "../auctions/alert/AuctionAlertCarousel";
import { AuctionHomeBanner } from "../auctions/banner/AuctionHomeBanner";
import { AuctionsHomeSearchBar } from "../auctions/auction/AuctionsHomeSearchBar";
...
export class AuctionsHome extends React.Component<Props, State> {
  static propTypes: {
      ...
      <>
        ...
        <div className={"grid-conatiner ui-ppms"}>
          ...
          <div className={"grid-row grid-gap-4"}>
            <AuctionAlertCarousel />
          </div>
          <div className={"grid-row grid-gap-4"}>
            <FeaturedItemsCarousel
              asynCall={salesApiService.getFeaturedItems(data)}

        ...
        <div className={"grid-col-4"}>
          <PPMSInput
            ...
            onChange={(event) => {
              ...
              props.onChangeCardNumber(event.target.value.trim());
              props.onChangeCardType(cardType?.niceType);
            }}
            onBlur={(event) => props.onBlurCardNumber(event.target.value)}

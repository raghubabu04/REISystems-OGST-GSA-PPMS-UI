...
export class AuctionsList extends React.Component<Props, State> {
  static propTypes: {
  ...
  render() {
    ...
    return (
      <>
        ...
        <AuctionPreview
          saleNumber={this.props?.match?.params?.saleNumber}
          stateCode={this.props?.match?.params?.stateCode}
          auctionStatus={this.props?.match?.params?.auctionStatus}

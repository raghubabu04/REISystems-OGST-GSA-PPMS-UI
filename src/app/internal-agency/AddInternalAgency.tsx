...
import {PocStateDefault, PocStateJson} from "./point-of-contact-class/PocState";
import {
  InternalAgencyAddressStateDefault,
  InternalAgencyAddressStateJson,
} from "./internal-agency-address-class/InternalAgencyAddressState";
import {
  InternalAgencyDetailsStateDefault,
  InternalAgencyDetailsStateJson,
} from "./internal-agency-details/InternalAgencyDetailsState";
import {
  InternalAgencyScreeningInfoDefault,
  InternalAgencyScreeningInfoStateJson,
} from "./internal-agency-screening-info-class/InternalAgencyScreeningInfoState";
import {
...
import {InternalAgencyStateDefault} from "./InternalAgencyState";
...
export interface AddInternalAgencyProps {
  match: any;
  location: any;
  history: any;
  context: any;
...
export function AddInternalAgency(props: AddInternalAgencyProps) {
  const {
    internalAgencyState,
  ...
  const items = [
    {
      ...
      content: <InternalAgencyDetailsClass editValidation={true} />,
  ...
  /*function toggleAccordion(event: any, accordianExpanded: boolean) {
  ...
  function setDefaultValues() {
    ...
    updateInternalAgencyState(InternalAgencyStateDefault);
    updateInternalAgencyDetailsState(InternalAgencyDetailsStateDefault);
    updateInternalAgencyAddressState(InternalAgencyAddressStateDefault);
    updatePocState(PocStateDefault);
    updateInternalAgencyScreeningInfoState(InternalAgencyScreeningInfoDefault);
    updateInternalAgencyRemarksState(InternalAgencyRemarksDefault);
  }
  ...
  function toJSON(isSubmitFlag: boolean): InternalAgencyDto {
    ...
    return ({
      ...
      agencyContact: {
        ...
        phone: internalAgencyPOC.phone.replace(/[^0-9]/g, ""),
        fax: internalAgencyPOC.fax.replace(/[^0-9]/g, ""),
        phoneExtension: internalAgencyPOC.phoneExtension.replace(/[^0-9]/g, ""),
      },
    ...
    if (form.checkValidity() === false || validationMessages.length > 0) {
      ...
      commonApiService
        ...
        .then(() => {
          ...
          addToast({
            text: "Internal Agency successfully added",
            type: "success",
            heading: "Success",
          });
          ...
          >
            <div className={"grid-row grid-gap-2"}>
              <InternalAgencyButtons
                ...
                id={"submit-internal-agency-button1"}
                cancelId={"cancel-internal-agency-button1"}
              />
            </div>
            <br/>
            ...
            <div className={"grid-row grid-gap-2"}>
              <InternalAgencyButtons
                ...
                isSubmitLoading={internalAgencyState.isSubmitLoading}
                cancelFunction={handleCancel}
                id={"submit-internal-agency-button2"}
                cancelId={"cancel-internal-agency-button2"}
              />
            </div>
          </Form>
        </div>
...
export default connect(null, mapDispatchToProps)(AddInternalAgency);

...
export class LotReviewFileUpload extends React.Component<
...
> {
  ...
  onDrop = (file, index) => {
    const { lotId, saleId, contractId } = this.props;
    file.attachmentOrder = this.state.files.length + (index + 1);

    let data = {
      objectId:
        this.props.objectType === "REFUND" ||
        this.props.objectType === "CONTRACT"
          ? contractId
          : lotId,
      objectType:
        this.props.objectType === "REFUND"
    ...
    let ctrlNumber =
      this.props.objectType === "REFUND"
        ? `${this.props.saleNumber}/${this.props.lotNumber}/${this.props.contractId}/refund`
        : this.props.objectType === "CONTRACT"
        ? `${this.props.saleNumber}/${this.props.lotNumber}/${this.props.contractId}`

import {SalesUserTypeState} from "../sales-user-type/SalesUserTypeState";

export interface SalesUserInformation {
    id?: bigint;
    firstName: string;
...
export const salesUserInformationDefault : SalesUserInformation = {
    id: null,
    firstName: "",
...
export const SalesUserInformationStateJson = (
...
) => [
  {
    ...
    phoneNumber: salesUserInformationState.phoneNumber,
    phoneExt: salesUserInformationState.phoneExtension,

...
export interface AddUserAccountMaintenanceState {
...
interface AddUserAccountMaintenanceProps {
  match: any;
  location: any;
  history: any;
  context: any;
...
export class AddUserAccountMaintenance extends React.Component<AddUserAccountMaintenanceProps,
  AddUserAccountMaintenanceState> {
  ...
  constructor(props: any) {
    ...
    } as AddUserAccountMaintenanceState;
  ...
  componentDidMount() {
    ...
    if (UserUtils.isSystemAdminUser()) {
  ...
  handleSubmit = (event: any) => {
    ...
    if (
      ...
      this.userApiService
        .addUserAccount(this.props.match.params.userId, data)
        .then((response: any) => {
          this.setState({
            isSubmitLoading: false,
            isSubmitDisabled: false,
  ...
  toJSON = (state: AddUserAccountMaintenanceState): UserAccount => {
...
export default connect(null, mapDispatchToProps)(AddUserAccountMaintenance);

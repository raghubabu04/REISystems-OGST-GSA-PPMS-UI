...
> {
  ...
  onDrop = (file, index) => {
    ...
    this.propertyService
      ...
      .then((response: any) => {
        ...
        request.append("controlNumber", this.props.tcn);
        request.append("type", "TCN");
  ...
  saveIconClick = async (fileId, tempName) => {
    ...
    let duplicateFile =  files.find((f) => (f.id !== fileId && f.name ===  fileToEdit.name ));
